...
#print("the most freq words (100):", vocab.most_common(100)) #help to remove agency_related contents 

df = pd.DataFrame(sentences)
df.columns = ["Ad_Desc"]
df .to_csv('sent_text.csv', encoding='utf-8', index = False, header=False) #save to new file. Manully classify the words.
...
###____________________________________________________####
filename_sent_text = "sent_text.csv"  
...
count_occur_df.to_csv('BagofWords.csv', encoding='utf-8', index=False)
...
vectors_df.to_csv('TF_iDF_keywords.csv', encoding='utf-8', index=False)
