...
train_x, valid_x, train_y, valid_y = model_selection.train_test_split(vectors_df, vectors_df.Words, test_size=0.2, random_state=42,stratify=vectors_df["Words"])
#print(train_x)
#print(valid_y)
